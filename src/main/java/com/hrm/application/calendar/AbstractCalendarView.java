...
import com.hrm.application.calendar.CalendarViewToolbar.CalendarViewToolbarBuilder;
...
//        eventTimeFormat.put("hour12", false);
        initialOptions.put("timeZone", "Asia/Taipei");
        initialOptions.put("locale", "en"); // 設定為英文
